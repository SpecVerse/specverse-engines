 ...
 */
export const COMMON_PROPERTY_MAPPINGS = {
 ...
 */
export const COMPONENT_SPECIFIC_MAPPINGS = {
    table: {
        size: {
            small: {
                shadcn: 'sm',
 ...
 */
export function mapProperty(componentType, propertyName, specverseValue, target) {
 ...
 */
export function getSemanticMeaning(propertyName, specverseValue) {
    const commonMapping = COMMON_PROPERTY_MAPPINGS[propertyName]?.[specverseValue];
 ...
 */
export function mapProperties(componentType, properties, target) {
    const mappedProperties = {};
    for (const [propName, propValue] of Object.entries(properties)) {
        mappedProperties[propName] = mapProperty(componentType, propName, propValue, target);
    }
 ...
 */
export function getFrameworkTargets(category) {
 ...
 */
export function hasMapping(componentType, propertyName, specverseValue, target) {
    const componentMapping = COMPONENT_SPECIFIC_MAPPINGS[componentType]?.[propertyName]?.[specverseValue];
    if (componentMapping && target in componentMapping) {
        return true;
    }
 ...
 */
export function getAllMappings(componentType, propertyName, specverseValue) {
    const componentMapping = COMPONENT_SPECIFIC_MAPPINGS[componentType]?.[propertyName]?.[specverseValue];
    if (componentMapping) {
